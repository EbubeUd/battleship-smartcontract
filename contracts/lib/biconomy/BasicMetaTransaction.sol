...
contract BasicMetaTransaction {
    ...
    event MetaTransactionExecuted(address payable userAddress, address payable relayerAddress, bytes functionSignature);
     ...
     */
    function executeMetaTransaction(address payable userAddress, bytes memory functionSignature,
        ...
        address payable senderAddress = payable(address(msg.sender));
        emit MetaTransactionExecuted(userAddress, senderAddress, functionSignature);
        return returnData;
    }
